...
description: Using Shizuku with Sugoi.
---

# Shizuku
**Shizuku** is an alternative method for installing and updating extensions in **Sugoi**.
...
After configuring it, enable **Shizuku** within **Sugoi** by navigating to <nav to="advanced"> then changing the **Installer** setting.
