...
::: tip
To convert your backups to JSON or to view and edit the information outside of the app, you can use [Sugoi Backup Viewer](https://github.com/Animeboynz/Sugoi-Backup-Viewer).
:::
...
During the setup or after restoring a backup to **Sugoi**:
1. In <nav to="data-and-storage">, double-check your specified [Storage location](/docs/faq/storage) that **Sugoi** has access to.
...
Cross device sync in **Sugoi** is not currently available, but users can use
...
1. On your second device, download the latest backup from your cloud service to restore into **Sugoi**.
...
All **Sugoi** (and **Tachiyomi**) [forks](/forks/) support the `.tachibk`/`.proto.gz` format to backup/restore your library.
