...
description: Sugoi intelligently manages series updates to reduce the load on sources.
---

# Smart updates

Sugoi intelligently works to reduce the number of series in a global update to reduce the load on sources. To be updated, a series has to meet the following conditions:
