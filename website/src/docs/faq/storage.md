...
Sugoi manages several things within a selected storage location, including automatic backups, chapter downloads, and the Local source.

::: tip Selecting a storage location
Keep the following in mind when setting up your Storage location:
* Create a "Sugoi" folder at the top-level of your storage (ex. `/Internal Storage/Sugoi/`).
...
* When selecting your storage location during the setup process, give access to the "Sugoi" folder, not the folders within.
:::
...
**Scoped Storage**'s introduction affects various storage-related functions in **Sugoi**.
