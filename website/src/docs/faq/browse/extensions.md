...
## Where can I find repositories/extensions for Sugoi?
Sugoi does not have, associate, or provide any repositories or extensions.
...
Sugoi is bring-your-own-content and does not offer anything.

::: info Disclaimer
**Sugoi** isn't responsible for slow, down, missing chapters, or subpar image quality of sources as it doesn't host the content.
:::
...
Uninstall extensions like regular apps: through device settings or in **Sugoi**.

::: tip Uninstalling an extension
In **Sugoi**, uninstall an extension via <nav to="extensions">, then tap **Uninstall** on the chosen extension.
:::
